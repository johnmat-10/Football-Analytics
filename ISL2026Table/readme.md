...
A high-fidelity, real-time strategic dashboard for the Indian Super League 2026 season. This tool goes beyond a standard standings table by providing mathematical projections, championship thresholds, and safety buffers based on live fixture data.
...
Dynamic Cutoff Lines: * Title Ceiling: A dashed line representing the highest points total any rival can still reach.
...
At Risk: The team's ceiling is lower than the leader's current points, and they are near the basement.
...
Data: CSV-to-JSON parsing engine with automated polling.

📂 Data Structure

The app reads from a GitHub-hosted CSV with the following mandatory columns:
